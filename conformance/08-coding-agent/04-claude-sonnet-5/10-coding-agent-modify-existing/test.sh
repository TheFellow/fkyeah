...
sed -e "s|__MODEL__|claude-sonnet-5|g" -e "s|__WORKDIR__|$WORKDIR|g" "$TEST_DIR/pipeline.dot" > "$RUNTIME_PIPELINE"
...
pass "claude-sonnet-5: coding agent modify-existing scenario passed"
