#!/usr/bin/env bash
# _generate.sh — Generate the 14x8 model × scenario test matrix
...
MODELS=(
    ...
    "13|claude-opus-4-8|claude_opus_4_8|ANTHROPIC_API_KEY"
    "14|claude-sonnet-5|claude_sonnet_5|ANTHROPIC_API_KEY"
)
