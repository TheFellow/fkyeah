...
assert_contains "$output" "FizzBuzz" "output contains FizzBuzz"
assert_contains "$output" "Fizz" "output contains Fizz"
assert_contains "$output" "Buzz" "output contains Buzz"

pass "claude-opus-4-8: Python FizzBuzz generated and validated"
