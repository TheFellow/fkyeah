...
module Library =
    ...
    let createTransport (endpoint: AcpEndpoint) =
        ...
        | AcpTransportKind.Stdio ->
            ...
            | _ ->
                Error(AcpError.InvalidPayload "Stdio endpoint requires command")
